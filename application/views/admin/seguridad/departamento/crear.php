    ...
    <div class="col-lg-12">
        <div class="panel panel-green">
            <div class="panel-heading">
                <span>Datos de Departamento</span>
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            <label class="control-label">Observacion <span class="required">*</span></label>
                             <input type=text" name="observacion" class="form-control" id="observacion" value="<?php echo set_value('observacion', isset($data->observacion) ? $data->observacion : '') ?>" observacion/>
