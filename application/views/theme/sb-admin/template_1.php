...
<html lang="es">
    <head>
        ...
        <!-- Custom  SGI Styles -->
        <link rel="stylesheet" type="text/css" href="<?php echo base_url() . TEMPLATEASSETSSGI ?>/css/ SGI.css">
        <!-- jQuery -->
    ...
    <body>
        ...
        <script type="text/javascript" src="<?php echo base_url() . TEMPLATEASSETSSGI ?>/js/ SGI.js"></script>
        <script>
